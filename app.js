...
function callQuestionThree() {
  ...
  if (que3 === 'DOGS') {
    alert('LOVE DOGS I have 2 of them');
  } else if (que3 == 'CATS') {
    alert('Like Cats but not as much as Dogs');
  } else {
    alert('That was not the Question');
  }
  console.log(que1 + ' guessed i like ' + que3);
}

/*Question4*/
function callQuestionFour() {
  var que5 = prompt('Can you Guess my Age');
  if (que5 > 31) {
    alert('You are too kind but I am 32 years Old');
  } else if (que5 = 32) {
    alert('Very good Guess Yes i am 32 yrs old');
  } else {
    alert('Good guess but I am not that old');
  }
  console.log(que1 + ' Guessed my age ' + que5 + 'years but I am 32 years old');
}

/*Question5*/
function callQuestionFive() {
  var que6 = prompt('Did I Ever join The U.S.Militry').toUpperCase();
  if (que6 === 'YES') {
    alert('Yes i served in U.S.NAVY');
  } else {
    alert('Wrong I served in U.S.Navy');
  }
}

/*Question6*/
function callQuestionSix() {
  var que7 = prompt('Guess how many countrys i have been. U only have 3 trys');
  if (que7 === 12) {
    alert('Dam you are Good thats a right answer');
  } else if (que7 > 12) {
    alert('Guess again but lower');
  } else {
    alert('Guess again but higher');
  }
}

/*Question7 guessing random number*/
function callQuestionSeven() {
...
// Question8 guessing from an array
function callQuestionEight() {
